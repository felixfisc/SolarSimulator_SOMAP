SamacSys ECAD Model
650319/310146/2.50/9/2/Integrated Circuit
...
(library Library_1
	...
	(padStyleDef "r330_241"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 2.41) (shapeHeight 3.3))
		(padShape (layerNumRef 16) (padShapeType Ellipse)  (shapeWidth 0) (shapeHeight 0))
	)
	...
	(patternDef "SOIC127P600X170-9N" (originalName "SOIC127P600X170-9N")
		(multiLayer
			...
			(pad (padNum 9) (padStyleRef r330_241) (pt 0, 0) (rotation 0))
		)
	...
	(symbolDef "A6211GLJTR-T" (originalName "A6211GLJTR-T")
	...
	(compDef "A6211GLJTR-T" (originalName "A6211GLJTR-T") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "VIN") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "TON") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "EN") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "CS") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "6" (pinName "GND_1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "VCC") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "A6211GLJTR-T"))
		...
		(attr "Manufacturer_Part_Number" "A6211GLJTR-T")
		(attr "Mouser Part Number" "250-A6211GLJTR-T")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Allegro-MicroSystems/A6211GLJTR-T?qs=pUKx8fyJudB6ktKC8t53Sg%3D%3D")
		(attr "Arrow Part Number" "A6211GLJTR-T")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/a6211gljtr-t/allegro-microsystems")
		(attr "Description" "Led Driver 2A Buck")
		(attr "Datasheet Link" "https://www.allegromicro.com/~/media/Files/Datasheets/A6211-Datasheet.ashx")
		(attr "Height" "1.7 mm")
	)
