...
(library Library_1
	...
	(compDef "A6211GLJTR-T" (originalName "A6211GLJTR-T") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "TON") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "EN") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "CS") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "5" (pinName "VCC") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.allegromicro.com/~/media/Files/Datasheets/A6211-Datasheet.ashx")
		(attr "<Component Height>" "1.7")
		(attr "<STEP Filename>" "A6211GLJTR-T.stp")
		(attr "<STEP Offsets>" "X=-506.01;Y=392.56;Z=-744.6")
