...
(library Library_1
	...
	(compDef "L1HX-5070200000000" (originalName "L1HX-5070200000000") (compHeader (numPins 3) (numParts 1) (refDesPrefix LED)
		...
		(attr "<Hyperlink>" "https://www.mouser.com/datasheet/2/602/DS288_luxeon_hl2x_datasheet-1915899.pdf")
		(attr "<Component Height>" "2.385")
		(attr "<STEP Filename>" "L1HX-5070200000000.stp")
