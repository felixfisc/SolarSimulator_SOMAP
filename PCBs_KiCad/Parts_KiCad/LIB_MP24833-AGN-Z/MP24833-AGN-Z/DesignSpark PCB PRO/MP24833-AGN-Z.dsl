...
(library Library_1
	...
	(compDef "MP24833-AGN-Z" (originalName "MP24833-AGN-Z") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "VSS_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "OVP") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "FB") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "VSS_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "6" (pinName "INGND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "EN/DIM") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.monolithicpower.com/pub/media/document/MP24833-A_r1.01.pdf")
		(attr "Height" "1.7 mm")
	)
