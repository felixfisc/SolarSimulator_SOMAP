...
//1295373/310146/2.50/9/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MP24833-AGN-Z" (originalName "MP24833-AGN-Z")
	...
	(compDef "MP24833-AGN-Z" (originalName "MP24833-AGN-Z") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "VDD") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "2" (pinName "VSS_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "3" (pinName "OVP") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "4" (pinName "FB") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "9" (pinName "VSS_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "8" (pinName "SW") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Output))
		(compPin "7" (pinName "BST") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "INGND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "5" (pinName "EN/DIM") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Input))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MP24833-AGN-Z"))
		...
		(attr "Manufacturer_Part_Number" "MP24833-AGN-Z")
		(attr "Mouser Part Number" "946-MP24833-AGN-Z")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Monolithic-Power-Systems-MPS/MP24833-AGN-Z?qs=cslStgdnz9M1gG6C9BalrA%3D%3D")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "LED Lighting Drivers 3A 200kHz Internal Power MOSFET")
		(attr "<Hyperlink>" "https://www.monolithicpower.com/pub/media/document/MP24833-A_r1.01.pdf")
		(attr "<Component Height>" "1.7")
		(attr "<STEP Filename>" "MP24833-AGN-Z.stp")
