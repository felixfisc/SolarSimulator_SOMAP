...
(library Library_1
	...
	(patternDef "SRR1210" (originalName "SRR1210")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.30317, 0.05647) (textStyleRef "Normal") (isVisible True))
		)
	...
	(compDef "SRR1210-680M" (originalName "SRR1210-680M") (compHeader (numPins 2) (numParts 1) (refDesPrefix L)
		...
		(attr "<Hyperlink>" "https://www.bourns.com/pdfs/SRR1210.pdf")
		(attr "<STEP Filename>" "SRR1210-680M.stp")
		(attr "<STEP Offsets>" "X=0;Y=-0.35;Z=0")
